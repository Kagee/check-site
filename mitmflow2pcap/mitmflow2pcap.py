...
with open(sys.argv[1], "rb") as logfile:
    ...
    try:
        ...
        for f in freader.stream():
            ...
            if server_port == 443:
                # We lie about the server port to get rid of a Wireshark warning
                server_port = 80;

            if client_port in client_ports:
                # If the client port is reused, we lie about it to get rid of a 
                # Wireshark warning
            ...
            #print("")
        wrpcap(sys.argv[2],pkts,linktype=1)
